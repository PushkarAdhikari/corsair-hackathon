...
export function McpAgentChatView({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Header */}
      <div className="p-4 border-b border-[#121226] flex items-center justify-between bg-[#040409]/50">
        <div className="flex items-center gap-2.5">
          <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
          <span className="text-xs font-bold text-white tracking-wide">Corsair MCP Agent Assistant</span>
        </div>
        ...
        {chatMessages.length === 0 ? (
          ...
          <div className="max-w-md mx-auto w-full text-center my-auto py-12 flex flex-col items-center">
            ...
            <div className="relative mb-6">
              ...
              <div className="h-14 w-14 rounded-2xl bg-[#090915] border border-indigo-500/30 flex items-center justify-center relative shadow-2xl">
                <svg className="h-7 w-7 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                {/* Sparkles */}
                <span className="absolute top-[-4px] right-[-4px] text-[10px]">✨</span>
              </div>
            </div>

            <h3 className="text-sm font-black text-white tracking-wider">Meet your Command Center Agent</h3>
            ...
            <div className="w-full mt-10 text-left space-y-3">
              ...
              <button
                ...
                className="w-full text-left p-3.5 bg-white/[0.01] hover:bg-white/[0.03] border border-white/[0.04] hover:border-white/[0.08] rounded-xl text-[11px] text-indigo-300 font-bold transition-all"
              >
                Send a calendar invite to <span className="text-white">pushkaradhikari.dev@gmail.com</span> at <span className="text-white">9 AM next Thursday</span>. Email him saying I look forward to it.
              </button>
          ...
          <div className="space-y-4 max-w-2xl mx-auto w-full pr-1">
            {chatMessages
              ...
              .map((msg, index) => {
                ...
                return (
                  ...
                  >
                    {!isUser && (
                      <div className="h-7 w-7 rounded-lg bg-indigo-500/10 border border-indigo-500/25 flex items-center justify-center shrink-0">
                    ...
                    <div className={`p-4 rounded-2xl text-[11.5px] leading-relaxed font-medium ${isUser
                      ...
                      : "bg-[#181830]/40 border border-[#232348]/45 text-slate-100 rounded-tl-none whitespace-pre-line"
                      }`}>
                      {text}
                    </div>
                  </div>
            ...
            {isPending && (
              <div className="flex gap-3.5 mr-auto max-w-[80%] items-center animate-pulse">
                ...
                <div className="flex gap-1 bg-[#181830]/40 border border-[#232348]/45 p-3.5 rounded-2xl rounded-tl-none text-[11px] text-slate-400 font-bold">
      ...
      <div className="p-4 border-t border-[#121226] bg-[#040409]">
        ...
        >
          ...
          <input
            ...
            disabled={isPending}
            className="w-full bg-[#080811] border border-[#16162d] focus:border-indigo-500/50 rounded-xl pl-10 pr-12 py-3 text-xs text-white focus:outline-none transition-all placeholder-slate-500"
          />
          <button
            type="submit"
