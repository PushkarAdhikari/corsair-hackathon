...
export function SettingsApiView({
  ...
  return (
    <div className="p-8 max-w-4xl w-full mx-auto space-y-6 overflow-y-auto h-full">
      {/* Header */}
      <div className="flex items-center gap-3.5 pb-4 border-b border-[#121226]">
        <div className="h-10 w-10 rounded-xl bg-indigo-950/40 border border-indigo-500/20 flex items-center justify-center">
        ...
        <div>
          <h2 className="text-sm font-black text-white tracking-wider">System Settings</h2>
          <p className="text-[11px] text-slate-500 font-semibold mt-1">Configure credentials and sync rules for Google Integrations.</p>
        </div>
      </div>

      {/* Execution Mode Card */}
      <div className="bg-[#080813] border border-[#1a1a36] rounded-2xl p-6 flex items-center justify-between shadow-lg">
        <div className="max-w-xl space-y-1.5">
          <h3 className="text-xs font-bold text-white uppercase tracking-wider">Execution Mode</h3>
        ...
        <button
          ...
          className={`px-4 py-2.5 rounded-xl border text-[11px] font-bold tracking-wide flex items-center gap-2.5 transition-all select-none active:scale-95 cursor-pointer ${
            isSandboxMode
              ? "bg-indigo-600/10 border-indigo-500/40 text-indigo-200"
              : "bg-[#181830] border-[#2a2a52] text-slate-300"
          }`}
        >
          {/* Toggle Pill Icon */}
          <div className={`w-8 h-4.5 rounded-full p-0.5 transition-colors ${isSandboxMode ? "bg-indigo-500" : "bg-slate-600"}`}>
            <div className={`w-3.5 h-3.5 rounded-full bg-white transition-transform ${isSandboxMode ? "translate-x-3.5" : "translate-x-0"}`} />
          </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-[#080813] border border-[#1a1a36] rounded-2xl p-6 flex flex-col justify-between shadow-lg">
          <div className="space-y-4">
            <div className="flex justify-between items-center pb-2 border-b border-[#121226]">
              <h3 className="text-xs font-bold text-white uppercase tracking-wider">Gmail API Setup</h3>
            ...
            <div className="space-y-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[#040409] border border-[#13132a] focus:border-indigo-500/40 rounded-xl px-3 py-2 text-[11px] text-white focus:outline-none placeholder-slate-600"
                />
              </div>
              <div className="space-y-1">
          ...
          <button
            ...
            className={`w-full mt-6 py-2.5 rounded-xl border text-xs font-bold tracking-wide flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer ${
              gmailConnected
                ? "bg-rose-950/15 border-rose-500/20 text-rose-300 hover:bg-rose-900/10"
        ...
        <div className="bg-[#080813] border border-[#1a1a36] rounded-2xl p-6 flex flex-col justify-between shadow-lg">
          <div className="space-y-4">
            <div className="flex justify-between items-center pb-2 border-b border-[#121226]">
              <h3 className="text-xs font-bold text-white uppercase tracking-wider">Google Calendar Setup</h3>
              <span className={`text-[9px] font-extrabold uppercase px-2 py-0.5 rounded tracking-wider ${
                calendarConnected
                  ? "bg-[#10b981]/15 text-[#10b981] border border-[#10b981]/20"
                  : "bg-[#f59e0b]/15 text-[#f59e0b] border border-[#f59e0b]/20"
      ...
      <div className="bg-[#080813] border border-[#1a1a36] rounded-2xl p-6 space-y-4 shadow-lg">
        <div className="flex items-center gap-2 pb-2 border-b border-[#121226]">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-3.5 p-4 bg-[#040409]/60 border border-[#13132a] rounded-xl text-xs font-semibold text-slate-300">
            ...
            <div>
              <h4 className="text-[11px] font-bold text-white leading-none">Key Encryption Key</h4>
          ...
          <div className="flex items-center gap-3.5 p-4 bg-[#040409]/60 border border-[#13132a] rounded-xl text-xs font-semibold text-slate-300">
            ...
            <div>
              <h4 className="text-[11px] font-bold text-white leading-none">PostgreSQL Pool</h4>
              <p className="text-[10px] text-emerald-500 font-semibold mt-1 flex items-center gap-1.5">
                <span className="h-1.5 w-1.5 bg-emerald-500 rounded-full animate-pulse" /> Active and Connected
              </p>
            </div>
          </div>
        </div>
